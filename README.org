...
- [notespace](https://github.com/scicloj/notespace) -- a tool for literate programming and dynamic data exploration/visualization
- [gorilla-notes](https://github.com/scicloj/gorilla-notes) -- the Notespace frontend - a simple app for pushing data visualizations from the REPL to the browser
- `kinds` -- specifying different kinds of rendering behavior across tools in an extensible way
- [handbook](https://scicloj.github.io/scicloj-data-science-handbook/) -- a central place for creating tutorials
